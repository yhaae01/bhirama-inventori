            ...
            <?php if ($user['role'] == 'admin') : ?>
                ...
                <li class="dropdown <?= (strpos(current_url(), "laporan") !== false) ? "active" : ""; ?>">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="<?= (strpos(current_url(), "laporan/PengembalianBarang") !== false) ? "active" : ""; ?>">
                            <a class="nav-link" href="<?= base_url('laporan/PengembalianBarang') ?>"> <span>Pengembalian Barang</span></a>
                        </li>
