                        ...
                        <div class="card-body">
                            <form action="<?php echo $action; ?>" method="post" enctype='multipart/form-data'>
                                ...
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" value="<?php echo $nama_supplier; ?>" />
                                    <?= form_error('nama_supplier', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <textarea class="form-control" style="height:100%;" rows="3" name="alamat" id="alamat" ><?php echo $alamat; ?></textarea>
                                    <?= form_error('alamat', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="varchar">No Telp</label>
                                    <input type="number" class="form-control" name="no_telp" id="no_telp" value="<?php echo $no_telp; ?>" />
